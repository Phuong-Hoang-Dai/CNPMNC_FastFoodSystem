...
namespace AgentManager.WebApp.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public PositionsController(AgentManagerDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Positions != null ? 
                          ...
                          Problem("Entity set 'AgentManagerDbContext.Positions'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'AgentManagerDbContext.Positions'  is null.");
            }
            var position = await _context.Positions.FindAsync(id);
            if (position != null)
            {
